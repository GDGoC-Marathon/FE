...
class MyStudentCafeteriaWidget extends StatefulWidget {
  ...
  @override
  State<MyStudentCafeteriaWidget> createState() => _MyStudentCafeteriaWidgetState();
}
            ...
            return const Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: MenuCard(
                    categories: [
                      {'name': '뚝배기', 'price': '6000원', 'menu': '김치찌개'},
                      {'name': '명가', 'price': '7000원', 'menu': '불고기'},
                      {'name': 'Noodle', 'price': '5000원', 'menu': '잔치국수'},
