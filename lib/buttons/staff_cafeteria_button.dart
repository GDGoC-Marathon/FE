...
class StaffCafeteriaButton extends StatefulWidget {
  @override
  _StaffCafeteriaButtonState createState() => _StaffCafeteriaButtonState();
}

class _StaffCafeteriaButtonState extends State<StaffCafeteriaButton> {
